...
%% Appendix Stage 01 | Generate and plot the independent signals S and their mixtures X (3 vars)
...
%% Appendix Stage 01 | Principal Component Analysis 
...
%% Appendix Stage 01 | Obtain the demixing matrix of X using EEGLAB and compute the independent components
...
% Before executing the operations below, it is necessary to use EEGLAB to
...
%% Appendix Stage 01 | Generate and plot the mixtures X (5 vars), compute and plot the PCs
...
%% Appendix Stage 01 | Obtain the demixing matrix of the first three PCs Y(1:3,:) using EEGLAB and compute the independent components
