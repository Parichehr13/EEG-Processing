%% Stage 03B | Group-level ERP analysis (GA)
...
%% Stage 03B | Load all-subject WSA data and compute grand averages
...
%% Stage 03B | Plot GA waveforms for Fz, Cz, and Pz
...
%% Stage 03B | Plot topographical maps of GA across time windows
