...
%% REST-TASK-REST ICA Stage | Load the file and plot the 13 EEG signals in time
...
%% REST-TASK-REST ICA Stage | Compute and plot the power spectral density of the 13 EEG signals (before artifact correction)
...
%% REST-TASK-REST ICA Stage | Save the EEG data X for their use in EEGLAB
% comment the following instruction after the first usage
%save rest_task_rest_ica_input.mat X

%% REST-TASK-REST ICA Stage | Perform ICA and obtain the demixing matrix (using the GUI of EEGLAB)
...
%% REST-TASK-REST ICA Stage | Load the demixing matrix, compute and plot the ICs as a function of time
...
%% REST-TASK-REST ICA Stage | Compute and plot the power spectral density of the estimated ICs
...
%% REST-TASK-REST ICA Stage | Identification of artifact components via exploration of time pattern, PSD, topographical map
...
%% REST-TASK-REST ICA Stage | Removal of the main artifact components, reconstruction of cleaned EEG, time pattern and PSD of the cleaned EEG
...
%% REST-TASK-REST ICA Stage | Computation of PSD of the cleaned EEG separately in different phases (R1, T, R2)
...
%% REST-TASK-REST ICA Stage | Average of PSD over frontal, temporo-central, parieto-occipital channels, and plot (3 subplots)
...
%% REST-TASK-REST ICA Stage | Compute the alpha power in each scalp region and for each phase, and plot
