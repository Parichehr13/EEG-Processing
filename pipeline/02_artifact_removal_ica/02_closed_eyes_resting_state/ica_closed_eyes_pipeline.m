...
%%same workflow as the open-eyes ICA stage
%% Closed-Eyes ICA Stage | Load the file and plot the 19 EEG signals in time (before artifact correction)
...
%% Closed-Eyes ICA Stage | Compute and plot the power spectral density of the 19 EEG signals (before artifact correction)
...
%% Closed-Eyes ICA Stage | Save the EEG data X for their use in EEGLAB

%%comment the following instruction after the first usage
%save closed_eyes_ica_input.mat X

%% Closed-Eyes ICA Stage | Perform ICA and obtain the demixing matrix (using the GUI of EEGLAB)
...
%% Closed-Eyes ICA Stage | Load the demixing matrix, compute and plot the ICs as a function of time
...
%% Closed-Eyes ICA Stage | Compute and plot the power spectral density of the estimated ICs
...
%% Closed-Eyes ICA Stage | Identification of artifact components via exploration of time pattern, PSD, topographical map
...
%% Closed-Eyes ICA Stage | Removal of the main artifact components, reconstruction of cleaned EEG, time pattern and PSD of the cleaned EEG
