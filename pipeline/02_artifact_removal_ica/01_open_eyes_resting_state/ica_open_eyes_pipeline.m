...
%% Open-Eyes ICA Stage | Load the file and plot the 19 EEG signals in time (before artifact correction)
...
%% Open-Eyes ICA Stage | Compute and plot the power spectral density of the 19 EEG signals (before artifact correction)
...
%% Open-Eyes ICA Stage | Save the EEG data X for their use in EEGLAB

%%comment the following instruction after the first usage
%save open_eyes_ica_input.mat X

%% Open-Eyes ICA Stage | Perform ICA and obtain the demixing matrix (using the GUI of EEGLAB)
...
%% Open-Eyes ICA Stage | Load the demixing matrix, compute and plot the ICs as a function of time
...
%% Open-Eyes ICA Stage | compute and plot the power spectral density of the estimated ICs
...
%% Open-Eyes ICA Stage | Identification of artifact components via exploration of time pattern, PSD, topographical map
...
%% Open-Eyes ICA Stage | Removal of the main artifact components, reconstruction of cleaned EEG, time pattern and PSD of the cleaned EEG
