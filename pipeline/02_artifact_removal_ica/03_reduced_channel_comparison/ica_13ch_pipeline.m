...
%%same workflow as the open-eyes and closed-eyes ICA stages

%% 13-Channel ICA Stage | Load the file and plot the 13 EEG signals in time (before artifact correction)
...
%% 13-Channel ICA Stage | Compute and plot the power spectral density of the 19 EEG signals (before artifact correction)
...
%% 13-Channel ICA Stage | Save the EEG data X for their use in EEGLAB

%%comment the following instruction after the first usage
%save ica_13ch_input.mat X

%% 13-Channel ICA Stage | Perform ICA and obtain the demixing matrix (using the GUI of EEGLAB)
...
%% 13-Channel ICA Stage | Load the demixing matrix, compute and plot the ICs as a function of time
...
%% 13-Channel ICA Stage | Compute and plot the power spectral density of the estimated ICs
...
%% 13-Channel ICA Stage | Identification of artifact components via exploration of time pattern, PSD, topographical map
...
%% 13-Channel ICA Stage | Removal of the main artifact components, reconstruction of cleaned EEG, time pattern and PSD of the cleaned EEG
