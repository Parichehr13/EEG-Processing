...
%% Stage 01 | Compute the power spectrum density of all signals and plot the PSD of electrodes n.10,11,53

if ~exist('X','var') || ~exist('srate','var')
    warning('X/srate not found in workspace. Loading raw data for section 5...');
