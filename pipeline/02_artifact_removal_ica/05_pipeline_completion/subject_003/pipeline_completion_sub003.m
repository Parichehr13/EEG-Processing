...
%% Pipeline Completion Stage | Add back bad channel(s) (all zeros) to the cleaned good channels and save the obtained dataset - SKIPPED
%%This stage is skipped since there is no bad channel in this recording

%% Pipeline Completion Stage | Bad channel interpolation in EEGLAB - SKIPPED
%%This stage is skipped since there is no bad channel in this recording
