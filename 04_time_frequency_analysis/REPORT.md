# Report: Stage 04 - Time-Frequency Analysis with CWT

## Objective
Stage 04 extends ERP analysis to the time-frequency domain and focuses on condition-dependent oscillatory changes in a 3-stimulus oddball task:
- `standard`,
- `target`,
- `distractor`.
...
- `tf_subject_analysis_cwt.m`, `tf_group_analysis_cwt.m`, `TF_colormap.m`.
