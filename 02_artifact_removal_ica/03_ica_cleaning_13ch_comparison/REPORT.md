...
## Results and Figures
### Raw 13-channel EEG (before correction)
![Raw EEG](figures/stage02c_p01_fig_001.png)

### PSD of raw EEG
![Raw EEG PSD](figures/stage02c_p02_fig_001.png)

### Estimated ICs (time domain)
![IC time courses](figures/stage02c_p05_fig_001.png)

### PSD of ICs
![IC PSD](figures/stage02c_p06_fig_001.png)

### Detailed IC inspection panels
![IC inspection 1](figures/stage02c_p07_fig_001.png)
![IC inspection 2](figures/stage02c_p07_fig_002.png)
![IC inspection 3](figures/stage02c_p07_fig_003.png)
![IC inspection 4](figures/stage02c_p07_fig_004.png)
![IC inspection 5](figures/stage02c_p07_fig_005.png)

### Cleaned EEG and pre/post PSD comparison
![Cleaned EEG (time)](figures/stage02c_p08_fig_001.png)
![PSD after correction](figures/stage02c_p08_fig_002.png)
![PSD before vs after](figures/stage02c_p08_fig_003.png)
